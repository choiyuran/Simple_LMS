...
//
////            List<String> possibleTimes = Arrays.asList("월,09:00-11:00", "월,13:00-15:00", "월,15:00-17:00",
////                    "화,09:00-11:00", "화,13:00-15:00", "화,15:00-17:00",
////                    "수,09:00-11:00", "수,13:00-15:00", "수,15:00-17:00",
////                    "목,09:00-11:00", "목,13:00-15:00", "목,15:00-17:00",
////                    "금,09:00-11:00", "금,13:00-15:00", "금,15:00-17:00");
////
////            Map<LectureRoom, List<String>> lectureRoomSchedules = new HashMap<>();
////            for (LectureRoom room : c1LectureRoom) {
////                lectureRoomSchedules.put(room, new ArrayList<>(possibleTimes));
////            }
////
...
////                LectureRoom room = c1LectureRoom.get(lectureRoomIndex);
////                List<String> availableTimes = lectureRoomSchedules.get(room);
////
////                if (!availableTimes.isEmpty()) {
////                    int timeIndex = ran.nextInt(availableTimes.size());
////                    String selectedTime = availableTimes.remove(timeIndex); // 선택한 시간대를 사용 가능 목록에서 제거
...
//                    String replace = m1LectureName.get(i).replace("(탐)", "");
//                    lectureTmp = new Lecture(replace, m1LectureIntro.get(i),
//                            3, "월, 화", "09:00,09:00", "11:00,11:00", Lecture_Type.전공탐색,
//                            c1m1Professor.get(professorIndex), 30, "2024년 1학기",
...
//                    String replace = m1LectureName.get(i).replace("(필)", "");
//                    lectureTmp = new Lecture(replace, m1LectureIntro.get(i),
//                            3, "월, 화", "09:00,09:00", "11:00,11:00", Lecture_Type.전공필수,
//                            c1m1Professor.get(professorIndex), 30, "2024년 1학기",
//                            2, null, c1Major.get(0), c1LectureRoom.get(lectureRoomIndex));
//                } else {
//                    lectureTmp = new Lecture(m1LectureName.get(i), m1LectureIntro.get(i),
//                            3, "월, 화", "09:00,09:00", "11:00,11:00", Lecture_Type.전공선택,
//                            c1m1Professor.get(professorIndex), 30, "2024년 1학기",
//                            2, null, c1Major.get(0), c1LectureRoom.get(lectureRoomIndex));
//                }
//                em.persist(lectureTmp);
...
//                        3, "월, 화", "09:00,09:00", "11:00,11:00", Lecture_Type.교양,
