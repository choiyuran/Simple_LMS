...
//                em.persist(manager3);
//
//                Student student1 = new Student(1, user7, professor1, major1, sqlDate);
//                Student student2 = new Student(2, user8, professor2, major2, sqlDate);
//                Student student3 = new Student(3, user9, professor3, major3, sqlDate);
//                em.persist(student1);
//                em.persist(student2);
//                em.persist(student3);
//
